...
Public Class HCComObject
    ...
    Public Shared Function GetPropertyValue(Of T)(ByVal comObject As Object, ByVal name As String) As T
        If Runtime.InteropServices.Marshal.IsComObject(comObject) = False Then Throw New Runtime.InteropServices.InvalidComObjectException()
    ...
    Public Shared Function GetCOMObjectType(ByVal comObject As Object) As Type
        ...
        Dim typeInfo As Runtime.InteropServices.ComTypes.ITypeInfo = Nothing
        ...
        Try
            ...
            If dispatch IsNot Nothing Then
                ...
                typeAttr = CType(Runtime.InteropServices.Marshal.PtrToStructure(
                                     pTypeAttr,
        ...
        Finally
            ...
            If typeInfo IsNot Nothing Then
                ...
                Runtime.InteropServices.Marshal.ReleaseComObject(typeInfo)
            End If
        End Try
