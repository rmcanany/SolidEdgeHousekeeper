...
Public Class Form_Main
    ...
    Public Property PreviewVersion As String = "14" ' ######### Empty string for a release
    ...
    Private Sub ListViewFiles_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ListViewFiles.SelectedIndexChanged
        ...
        If ListViewFiles.SelectedItems.Count > 0 Then
            ...
            Label_FileCounter.Text = $"{ListViewFiles.Items.Count} files - {ListViewFiles.SelectedItems.Count} selected"
        Else
            ButtonProcess.Text = "Process"
            Label_FileCounter.Text = ""
        End If
