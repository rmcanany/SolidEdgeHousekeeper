...
Public Class PartTasks
    ...
    Public Function InsertPartCopiesOutOfDate(
        ...
        ErrorMessage = InvokeSTAThread(
                               ...
                               SolidEdgeFramework.Application,
                               Dictionary(Of Integer, List(Of String)))(
                                   AddressOf CommonTasks.PartCopiesOutOfDate,
                                   SEDoc,
                                   Configuration,
                                   SEApp)
    ...
    Public Function MaterialNotInMaterialTable(
        ...
        ErrorMessage = InvokeSTAThread(
                               ...
                               SolidEdgeFramework.Application,
                               Dictionary(Of Integer, List(Of String)))(
                                   AddressOf CommonTasks.MaterialNotInMaterialTable,
                                   SEDoc,
                                   Configuration,
                                   SEApp)
    ...
    Public Function UpdateInsertPartCopies(
        ...
        ErrorMessage = InvokeSTAThread(
                               ...
                               SolidEdgeFramework.Application,
                               Dictionary(Of Integer, List(Of String)))(
                                   AddressOf CommonTasks.UpdatePartCopies,
                                   SEDoc,
                                   Configuration,
                                   SEApp)
    ...
    Public Function UpdateMaterialFromMaterialTable(
        ...
        ErrorMessage = InvokeSTAThread(
                               ...
                               SolidEdgeFramework.Application,
                               Dictionary(Of Integer, List(Of String)))(
                                   AddressOf CommonTasks.UpdateMaterialFromMaterialTable,
                                   SEDoc,
                                   Configuration,
                                   SEApp)
