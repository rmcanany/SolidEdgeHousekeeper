...
**Contributors**  
@[Francesco Arfilli] (github @farfilli), @daysanduski, @mmtrebuchet (github), @[o_o ....码], @ChrisNC (github @ChrisClems), @ZaPpInG (github @lrmoreno007), @aalian.khan8036 (github @AalianKhan), @KGeetings (github), @ih0nza (github), @artem1t (github), @Alex_H, Juri Bendoni -- Italy (github @JBen79), @robbin70

**Beta Testing, Bug Reports, and Helpful Feedback**  
@SatyenB, @n0minus38, @wku, @aredderson, @bshand, @TeeVar, @SeanCresswell, @Jean-Louis, @Jan_Bos, @MonkTheOCD_Engie, @[mike miller], @[Francesco Arfilli], @[Martin Bernhard], @[Derek G], @Chris42, @JasonT, @Bob Henry, @JayJay04, @Cimarian_RMP, @xenia.turon, @nate.arinta5649, @DaveG, @tempod, @64Pacific, @ben.steele6044, @KennyG, @Alex_H, @Nosybottle, @Seva, @HIL, @[o_o ....码], @roger.ribamatic, @jnewell, @[Robin BIoemberg], @Pedro0996, @Imre Szucs, @Bert303, @gir.isi, @BrianVR74, @CareFrame1, @john.matthews3452, @RBoyd347, @[Artur Sampaio], @pkoevesdi, @Jojo15702, @chjchen, @FERNANDO-DALLAGNOLO, @ih0nza, @mefrebo, @KGeetings, @stephan.morin2873, @Nick_Mokrytskyi, @willhfr, @DieCola85, @[Nataniel Tasev], @Brendan.Lee (github @Bogob22), @sven-11111, @collands, @WoutM25, @Monostre, @Stefano-VLN, @MWinter_Deev, @PBurkeADS, @Lui10, @schumi1119, @Dirkels
...
You can show a file preview and/or customize the list to show file properties if desired.  Referring to the toolbar diagram, tool group 8. 

**File Preview**

Click ![Preview](My%20Project/media/preview_show.png) to enable a preview of a selected file on the list.

You can get a lot of information on the file by using Solid Edge Explorer.  Hold down the shift key and click the preview icon.

![Solid Edge Explorer](My%20Project/media/solid_edge_explorer.png)
...
<details open><summary><h2 style="margin:0px; display:inline-block"><img src="My%20Project/media/spacer.png"><img src="Resources/icons8_list_view_16.png"><img src="My%20Project/media/spacer.png">COMMAND LINE</h2></summary>
...
<details open><summary><h2 style="margin:0px; display:inline-block"><img src="My%20Project/media/spacer.png"><img src="Resources/SE_asm.png"><img src="My%20Project/media/spacer.png">TASK DETAILS</h2></summary>
...
- `Sheet scale not linked to a drawing view`: Checks what it says. 
...
The code snippet is just a text file written in VB.Net syntax.  It can be created in Notepad, or more conveniently in the expression editor.  Click `Edit *.snp` to use the editor.  See the **Edit Properties Help Topic** for details on using the editor.  
...
Sheetmetal files (including `*.par` "switched to" sheetmetal) have two additional options -- `DXF Flat (*.dxf)` and `PDF Drawing (*.pdf)`. The `DXF Flat` option saves the flat pattern of the sheet metal file. Note the file's flat pattern must be of type `Flatten`, not `Blank`. The program is not able to handle the latter.  You will have to do those manually. If such a condition is found, it is reported in the log file. 
...
<details open><summary><h2 style="margin:0px; display:inline-block"><img src="My%20Project/media/spacer.png"><img src="Resources/icons8-gold-star-16.png"><img src="My%20Project/media/spacer.png">BECOME A SPONSOR</h2></summary>
