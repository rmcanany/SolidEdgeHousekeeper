...
This is to tell the user that the file list is not automatically populated when folders are selected.  There are reasons, but it is confusing for new users.  It's very annoying and you'll want to disable it right away.
</details>
