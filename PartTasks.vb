            ...
            Sub(_CurrentMaterialFaceStyle)
                ...
                If (Models.Count > 0) And (Models.Count < 300) Then
                    For Each Model In Models
                        ...
                        '    Dim FeatureType = SolidEdgeCommunity.Runtime.InteropServices.ComObject.GetPropertyValue(Of SolidEdgeFramework.ObjectType)(Feature, "Type", CType(0, SolidEdgeFramework.ObjectType))

                        '    For Each FeatureTypeConstant In System.Enum.GetValues(GetType(SolidEdgePart.FeatureTypeConstants))
                        '        If FeatureType.ToString = FeatureTypeConstant.ToString Then
                        '            FeatureFaceStyle = CType(Feature, FeatureTypeConstant).GetStyle()
