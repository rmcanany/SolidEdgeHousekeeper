...
Partial Class Form1
    ...
    Private Sub LoadTextBoxReadme()
        ...
        Dim CheckedListBoxList As New List(Of CheckedListBox)
        ...
        CheckedListBoxList.Add(CheckedListBoxAssembly)
        CheckedListBoxList.Add(CheckedListBoxPart)
        CheckedListBoxList.Add(CheckedListBoxSheetmetal)
        CheckedListBoxList.Add(CheckedListBoxDraft)
